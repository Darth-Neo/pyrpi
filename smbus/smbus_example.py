...
def setup_accel(range):
    ...
    # incoming "range" can be 2, 4, or 8. 
    #  Default is 8 if it's not 2 or 4.
...
def accel_axis_reading(register):
    ...
    if(axis_reading > 511):
        # This deals with 2's compliment of raw reading 10 bit number
        axis_reading = -1*(1023-axis_reading)
